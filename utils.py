...
def parse_args():
    ...
    parser.add_argument("--output_interval", type=int, default=100, help="debug info show")
    ...
    parser.add_argument("--resume", type=bool, default=True, help="Resume training from the latest checkpoint")
